    ...
    <header>
      <div class="flex items-center gap-4 sm:gap-6 mb-4">
        ...
        <div class="flex-1 min-w-0">
          <h1 class="text-2xl sm:text-4xl font-bold mb-2">Marcos J. Castaneda</h1>
      ...
      <p class="text-base sm:text-lg text-gray-500 dark:text-gray-300 mb-5 leading-relaxed">
        Building scalable, reliable backend systems and customer-facing products at Google and AWS,
